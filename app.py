...
def whatsapp_reply():
    mensaje = request.form.get("Body")  # Mensaje del usuario
    numero = request.form.get("From")   # Número del usuario

    respuesta_bot = responder_mensaje(mensaje)  # Usa tu función de IA para responder
...
async def start(update: Update, context):
    await update.message.reply_text("¡Hola! Soy IUVADITO 🤖. Pregúntame lo que quieras.")
